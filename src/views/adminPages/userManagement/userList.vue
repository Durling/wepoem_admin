<template>
  <div class="app-container calendar-list-container">
    ...
    <el-table :key='tableKey' :data="list" v-loading="listLoading" element-loading-text="给我一点时间" border fit highlight-current-row
      ...
      <el-table-column min-width="" :label="$t('table.in_unique_code')">
        <template slot-scope="scope">
          <span>{{scope.row.in_unique_code}}</span>
        </template>
      </el-table-column>
      ...
      <el-table-column width="" :label="$t('table.signature')">
        <template slot-scope="scope">
          <span>{{scope.row.signature}}</span>
        </template>
      </el-table-column>
      <el-table-column align="center" :label="$t('table.city')" width="">
        <template slot-scope="scope">
...
export default {
  ...
  data() {
    return {
      ...
      email_status_name: ['未验证', '已验证'],
      phone_status_name: ['未验证', '已验证'],
      sex_name: ['', '男', '女'],
      type_name: ['', '', '自然注册']
    }
  },
